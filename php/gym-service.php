...
<body style="text-align: center;">
  <div class="container" class="services section-bg" style="margin:10%;">
    ...
    <div class="text-center">
      ...
      <h3 id='productName'>Gym Consulting</h3>
      <div class="row">
        <div class="col-6 p-4">
          <div class="portfolio-wrap">
            <img src="../assets/img/p-3.jpeg" class="img-fluid" alt="">
          </div>
        </div>
        <div class="col-6" style="margin: auto;">
          <div class="card" style="border:none;">
            ...
            <p style="text-align: left;">We provide virtual and inperson gym consulting for busy professionals which include varieties of effective excercises</p>
          </div>
