...
<body style="text-align: center;">
  <div class="container" class="services section-bg" style="margin:10%;">
    ...
    <div class="text-center">
      ...
      <h3 id='productName'>Community Connect</h3>
      <div class="row">
        <div class="col-6 p-4">
          <div class="portfolio-wrap">
            <img src="../assets/img/p-9.jpeg" class="img-fluid" alt="">
          </div>
        </div>
        <div class="col-6" style="margin: auto;">
          <div class="card" style="border:none;">
            ...
            <p style="text-align: left;">The Community Connect Program supports individual and community health through assessment and interventions that help vulnerable people get connected to the resources they need.</p>
          </div>
