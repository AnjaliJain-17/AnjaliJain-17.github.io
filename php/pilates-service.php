...
<body style="text-align: center;">
  <div class="container" class="services section-bg" style="margin:10%;">
    ...
    <div class="text-center">
      ...
      <h3 id='productName'>Pilates</h3>
      <div class="row">
        <div class="col-6 p-4">
          <div class="portfolio-wrap">
            <img src="../assets/img/p-7.jpeg" class="img-fluid" alt="">
          </div>
        </div>
        <div class="col-6" style="margin: auto;">
          <div class="card" style="border:none;">
            ...
            <p style="text-align: left;">With over 3,400 Pilates classes for all levels and durations, our custom filters will help you find what's right for you today, or join a challenge to begin. All you need is a mat</p>
          </div>
